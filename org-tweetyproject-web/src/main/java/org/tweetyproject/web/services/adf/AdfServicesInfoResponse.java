...
/**
 * The AdfServicesInfoResponse class extends the Response class and represents
 * a response containing information about ADF argumentation services.
 */
public class AdfServicesInfoResponse extends Response {

    /** The reply message in the ADF services info response */
    private String reply;

    /** The email associated with the ADF services info response */
    private String email;

    /** The backend timeout value specified in the ADF services info response */
    private int backend_timeout;

    /** The list of supported semantics in the ADF services info response */
    private List<String> semantics;

    /** The list of supported commands in the ADF services info response */
    private List<String> commands;

    /**
     * Default constructor for AdfServicesInfoResponse.
     */
    public AdfServicesInfoResponse() {
    }

    /**
     * Parameterized constructor for ADFServicesInfoResponse.
     *
     ...
     */
    public AdfServicesInfoResponse(String reply, String email, int backend_timeout, List<String> semantics, List<String> commands) {
        this.reply = reply;
        this.email = email;
     ...
     */
    public AdfServicesInfoResponse reply(String reply) {
        setReply(reply);
        return this;
    }
     ...
     * @return This instance to facilitate further modifications.
     */
    public AdfServicesInfoResponse email(String email) {
        setEmail(email);
        return this;
    }
     ...
     * @return This instance to facilitate further modifications.
     */
    public AdfServicesInfoResponse backend_timeout(int backend_timeout) {
     ...
     * @return This instance to facilitate further modifications.
     */
    public AdfServicesInfoResponse semantics(List<String> semantics) {
     ...
     * @return This instance to facilitate further modifications.
     */
    public AdfServicesInfoResponse commands(List<String> commands) {
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof AdfServicesInfoResponse)) {
            return false;
        }
        AdfServicesInfoResponse adfServicesInfoResponse = (AdfServicesInfoResponse) o;
        return Objects.equals(reply, adfServicesInfoResponse.reply) && Objects.equals(email, adfServicesInfoResponse.email) && backend_timeout == adfServicesInfoResponse.backend_timeout && Objects.equals(semantics, adfServicesInfoResponse.semantics) && Objects.equals(commands, adfServicesInfoResponse.commands);
    }
