...
public class RankingReasonerCalleeFactory {
    ...
    /**
     * Creates and returns a Callee instance based on the provided Command, AbstractRankingReasoner,
     * and DungTheory parameters.
     *
     * @param cmd      The command to be executed
     * @param reasoner The AbstractRankingReasoner to be used
     ...
     */
    public static Callee getCallee(Command cmd, AbstractRankingReasoner<?> reasoner, DungTheory bbase) {
        switch (cmd) {
            case GET_MODEL:
                return new RankingReasonerGetModelCallee(reasoner, bbase);
            default:
