...
/**
 * The IafServicesInfoResponse class extends the Response class and represents
 * a response containing information about Iaf argumentation services.
 */
public class IafServicesInfoResponse extends Response {

    /** The reply message in the Iaf services info response */
    private String reply;

    /** The email associated with the Iaf services info response */
    private String email;

    /** The backend timeout value specified in the Iaf services info response */
    private int backend_timeout;

    /** The list of supported semantics in the Iaf services info response */
    private List<String> semantics;

    /** The list of supported commands in the Iaf services info response */
    private List<String> commands;

    /**
     * Default constructor for IafServicesInfoResponse.
     */
    public IafServicesInfoResponse() {
    }

    /**
     * Parameterized constructor for IafServicesInfoResponse.
     *
     ...
     */
    public IafServicesInfoResponse(String reply, String email, int backend_timeout, List<String> semantics, List<String> commands) {
        this.reply = reply;
        this.email = email;
     ...
     */
    public IafServicesInfoResponse reply(String reply) {
        setReply(reply);
        return this;
    }
     ...
     * @return This instance to facilitate further modifications.
     */
    public IafServicesInfoResponse email(String email) {
        setEmail(email);
        return this;
    }
     ...
     * @return This instance to facilitate further modifications.
     */
    public IafServicesInfoResponse backend_timeout(int backend_timeout) {
     ...
     * @return This instance to facilitate further modifications.
     */
    public IafServicesInfoResponse semantics(List<String> semantics) {
     ...
     * @return This instance to facilitate further modifications.
     */
    public IafServicesInfoResponse commands(List<String> commands) {
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof IafServicesInfoResponse)) {
            return false;
        }
        IafServicesInfoResponse iafServicesInfoResponse = (IafServicesInfoResponse) o;
        return Objects.equals(reply, iafServicesInfoResponse.reply) && Objects.equals(email, iafServicesInfoResponse.email) && backend_timeout == iafServicesInfoResponse.backend_timeout && Objects.equals(semantics, iafServicesInfoResponse.semantics) && Objects.equals(commands, iafServicesInfoResponse.commands);
    }
