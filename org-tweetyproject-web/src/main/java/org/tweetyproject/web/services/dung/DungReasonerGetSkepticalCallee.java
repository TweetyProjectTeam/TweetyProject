 ...
 * @author Lars Bengel
 */
public class DungReasonerGetSkepticalCallee extends Callee {

    /** The AbstractExtensionReasoner used for obtaining the model */
    private AbstractAcceptabilityReasoner reasoner;
     ...
     */
    public DungReasonerGetSkepticalCallee(AbstractExtensionReasoner reasoner, DungTheory bbase) {
        this.reasoner = new EeeAcceptabilityReasoner(reasoner, InferenceMode.SKEPTICAL);
        this.bbase = bbase;
    }
