 ...
 * result.
 */
public class SetAfReasonerResponse extends Response {
     ...
     */
    public SetAfReasonerResponse(String reply, String email, int nr_of_arguments, List<List<Integer>> attacks,
     ...
     */
    public SetAfReasonerResponse reply(String reply) {
        setReply(reply);
        return this;
    }
     ...
     * @return The current instance of DungReasonerResponse.
     */
    public SetAfReasonerResponse email(String email) {
        setEmail(email);
        return this;
    }
     ...
     * @return The current instance of DungReasonerResponse.
     */
    public SetAfReasonerResponse nr_of_arguments(int nr_of_arguments) {
     ...
     * @return The current instance of DungReasonerResponse.
     */
    public SetAfReasonerResponse attacks(List<List<Integer>> attacks) {
        setAttacks(attacks);
        return this;
    }
     ...
     * @return The current instance of DungReasonerResponse.
     */
    public SetAfReasonerResponse semantics(String semantics) {
     ...
     * @return The current instance of DungReasonerResponse.
     */
    public SetAfReasonerResponse solver(String solver) {
        setSolver(solver);
        return this;
    }
     ...
     * @return The current instance of DungReasonerResponse.
     */
    public SetAfReasonerResponse answer(String answer) {
        setAnswer(answer);
        return this;
    }
     ...
     * @return The current instance of DungReasonerResponse.
     */
    public SetAfReasonerResponse time(int time) {
        setTime(time);
        return this;
    }
     ...
     * @return The current instance of DungReasonerResponse.
     */
    public SetAfReasonerResponse status(String status) {
        setStatus(status);
        return this;
    }
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof SetAfReasonerResponse)) {
            return false;
        }
        SetAfReasonerResponse tweetyResponse = (SetAfReasonerResponse) o;
