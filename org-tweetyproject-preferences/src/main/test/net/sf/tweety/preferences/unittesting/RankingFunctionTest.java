...
public class RankingFunctionTest {
	...
	public void testGetPredecessors_fixture_1()
		...
		//       at org.tweetyproject.preferences.ranking.RankingFunction.getPredecessors(RankingFunction.java:271)
		assertNotNull(result);
	}
	...
	public void testGetSuccessors_fixture_1()
		...
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.NullPointerException
		//       at org.tweetyproject.preferences.ranking.RankingFunction.getSuccessors(RankingFunction.java:281)
		assertNotNull(result);
	}
