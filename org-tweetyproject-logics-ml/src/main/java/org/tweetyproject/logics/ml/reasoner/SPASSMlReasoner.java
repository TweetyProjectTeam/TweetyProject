 ...
 * 
 * <br> Note: There are unresolved errors for some cases, see org.tweetyproject.logics.ml.SPASSTest#ComplexQueryTest() for examples.
 * 
 * @author Anna Gessler
...
public class SPASSMlReasoner extends AbstractMlReasoner {
	...
	/* (non-Javadoc)
	 * @see org.tweetyproject.logics.ml.reasoner.AbstractModalReasoner#query(org.tweetyproject.logics.ml.syntax.ModalBeliefSet, org.tweetyproject.logics.fol.syntax.FolFormula)
	 */
	@Override
	 ...
	 * May decrease SPASS's performance, use {@link org.tweetyproject.logics.ml.reasoner.SPASSMlReasoner#query(MlBeliefSet,FolFormula)}
