...
/**
 * Writes an epistemic abstract argumentation framework into a file of the TGF format including the constraint given as a epistemic formula.
 *
 * @author Sandra Hoffmann
 *
 */
public class EafTgfWriter extends AbstractEafWriter{
	/** Default */
	public EafTgfWriter(){
	 ...
	 *
	 * @param eaf       The ConstrainedArgumentationFramework to write.
	...
	public void write(EpistemicArgumentationFramework eaf, File f) throws IOException {
		...
		writer.println("#");
		writer.println(eaf.getConstraint().toString());
		writer.close();		
	}
}
