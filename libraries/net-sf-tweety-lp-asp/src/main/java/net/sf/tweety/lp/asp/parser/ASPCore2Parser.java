...
/**
 * Parser for ASP-Core-2 input syntax (<a href=
 * "https://www.mat.unical.it/aspcomp2013/files/ASP-CORE-2.03c.pdf">https://www.mat.unical.it/aspcomp2013/files/ASP-CORE-2.03c.pdf</a>).
 * Additionally, the parser provides methods to parse answer sets given by the
 * Clingo Solver. <br>
 * <br>
...
public class ASPCore2Parser
		/* @bgen(jjtree) */ implements ASPCore2ParserTreeConstants, ASPCore2ParserConstants {/* @bgen(jjtree) */
	...
	private boolean jj_3R_47() {
		if (jj_scan_token(PAREN_OPEN))
			return true;
		if (jj_3R_22())
			return true;
		if (jj_scan_token(PAREN_CLOSE))
			return true;
		if (jj_3R_67())
			return true;
		return false;
	...
	private boolean jj_3R_29() {
		...
		if (jj_scan_token(DOT))
			return true;
		if (jj_scan_token(SQUARE_OPEN))
			return true;
		if (jj_3R_39())
			return true;
		if (jj_scan_token(SQUARE_CLOSE))
			return true;
		return false;
	}
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x400100, 0x400100, 0x4401f80, 0x4401f80, 0x80000, 0x4401f80, 0x44581f00, 0x400100, 0x80,
				0x4401f80, 0x4401f00, 0x400100, 0x0, 0x4401f80, 0x10000, 0x4401f00, 0x0, 0x4401f00, 0x4401f80, 0x10000,
				0x0, 0x4401f00, 0x4401f80, 0x10000, 0x0, 0x2000000, 0x4000, 0x80, 0x400180, 0x400000, 0x4401f00,
				0x4000000, 0x0, 0x4401f00, 0x4000000, 0x4401f00, 0x1e00000, 0x1200, };
	}

	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0xe40, 0xe40, 0x0, 0xe40, 0x180, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3f, 0x0, 0x0, 0x0,
				0x3f, 0x0, 0x0, 0x0, 0xe40, 0x0, 0x0, 0x0, 0x180, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3f, 0x0, 0x0,
				0x0, 0x0, 0x0, };
	}
