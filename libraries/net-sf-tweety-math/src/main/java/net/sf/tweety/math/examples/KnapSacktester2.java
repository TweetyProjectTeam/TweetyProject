...
public class KnapSacktester2 {
	...
	public static void main(String args[]) {
		...
		// solve the problem with a tabu size of 5, max 100000 iterations and max 2000
		// iterations without an improvement to the best solution
