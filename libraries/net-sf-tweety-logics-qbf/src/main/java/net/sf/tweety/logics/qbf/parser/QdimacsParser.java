 ...
 * <br>
 * 
 * To parse QDIMACS output files, use {@link net.sf.tweety.logics.qbf.parser.QdimacsParser#parseQDimacsOutput(String)}
 * 
 * @author Anna Gessler
 */
public class QdimacsParser extends DimacsParser {
	 ...
	 * The rest of the input file is parsed with {@link net.sf.tweety.logics.pl.parser.DimacsParser}.
	 */
