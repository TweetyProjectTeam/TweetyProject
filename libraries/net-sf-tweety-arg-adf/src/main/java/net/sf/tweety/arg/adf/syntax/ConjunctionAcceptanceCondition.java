...
public class ConjunctionAcceptanceCondition implements AcceptanceCondition {
	...
	public PlFormula toPlFormula(Function<Argument, PlFormula> argumentMap) {
		return new Conjunction(first.toPlFormula(argumentMap), second.toPlFormula(argumentMap));
