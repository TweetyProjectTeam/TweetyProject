 ...
 *
 */
public interface PreferredReasonerStrategy extends ReasonerStrategy {
	 ...
	 * 
	 * @see
	 * net.sf.tweety.arg.adf.reasoner.ReasonerStrategy#next(net.sf.tweety.arg.
	 * adf.reasoner.strategy.SearchSpace)
	 */
	@Override
	default Interpretation next(SearchSpace searchSpace) {
		return nextPreferred(searchSpace);
	}
}
