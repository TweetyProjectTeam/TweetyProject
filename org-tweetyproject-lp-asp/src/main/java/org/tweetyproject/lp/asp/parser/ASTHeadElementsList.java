...
public
class ASTHeadElementsList extends SimpleNode {
  public ASTHeadElementsList(int id) {
    super(id);
  }

  public ASTHeadElementsList(ASPCore2Parser p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=8c603a132437ab215438f6469814f137 (do not edit this line) */
