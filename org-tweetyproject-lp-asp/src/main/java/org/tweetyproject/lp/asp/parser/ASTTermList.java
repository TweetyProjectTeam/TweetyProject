...
/**
 * The {@code ASTTermList} class represents a node in the abstract syntax tree (AST)
 * for a list of terms within the context of Answer Set Programming (ASP). This class
 * extends {@code SimpleNode} and is used by the ASP parser to handle and represent
 * collections of terms that may appear in rules, facts, or other constructs within an ASP program.
 */
public class ASTTermList extends SimpleNode {

    /**
     * Constructs a new {@code ASTTermList} node with the specified identifier.
     *
    ...
    /**
     * Constructs a new {@code ASTTermList} node with the specified parser and identifier.
     *
...
/*
 * JavaCC - OriginalChecksum=6bb2ff4fb78b063b91d40becf0252dda (do not edit this
 * line)
 */
