...
/**
 * The {@code ASTNumber} class represents a node in the abstract syntax tree (AST)
 * for numerical values within the context of Answer Set Programming (ASP). This class
 * extends {@code SimpleNode} and is used by the ASP parser to handle and process numeric literals.
 */
public class ASTNumber extends SimpleNode {
    ...
    /**
     * Constructs a new {@code ASTNumber} node with the specified identifier.
     *
    ...
    /**
     * Constructs a new {@code ASTNumber} node with the specified parser and identifier.
     *
     ...
     *
     * @param number The string representing the number to be parsed and set.
     */
...
/*
 * JavaCC - OriginalChecksum=0eee017fa93d67e327810858ebaee6f4 (do not edit this
 * line)
 */
