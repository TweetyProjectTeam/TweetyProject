...
public class RecursiveExtendedTheory extends BeliefSet<Argument, DungSignature> implements ArgumentationFramework<Argument>, Collection<Argument> {
     ...
     * @return "true" iff 'attack' either directly attacks 'target' or recursively
     */
    ...
    /**
     * Determines whether the given set of arguments/attacks is conflict-free, i.e.,
     * whether all of its attacks are not in conflict with each other
     ...
     * @return "true" iff 'entity' is defended by 'ext'
     */
    ...
    /**
     * Determines whether 'ext' is admissible, i.e., if it is conflict-free and defends all its elements
     * @param ext some set of arguments/attacks
    ...
    /**
     * Determines whether 'ext' is complete, i.e., if it is admissible and includes all elements it defends
     * @param ext some set of arguments/attacks
    ...
    /**
     * Adds an recursive attack to the theory
     * @param attacker some argument
     ...
     * @return "true" iff 'a' is attacked by 'b'
     */
