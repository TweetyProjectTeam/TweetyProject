...
public class ForallQuantifiedModalFormula extends FolFormula {
	 ...
	 */
	public ForallQuantifiedModalFormula(RelationalFormula formula, Set<Variable> variables){
	 ...
	 */
	public ForallQuantifiedModalFormula(RelationalFormula formula, Variable variable){
		if(!(formula instanceof FolFormula || formula instanceof ModalFormula))
			throw new IllegalArgumentException("Formula must be first-order or modal formula.");
	...
	public ForallQuantifiedModalFormula(ForallQuantifiedModalFormula other) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ForallQuantifiedModalFormula other = (ForallQuantifiedModalFormula) obj;
	 ...
	 */
	@Override
	public ForallQuantifiedModalFormula substitute(Term<?> v, Term<?> t) throws IllegalArgumentException{
		if(this.getQuantifierVariables().contains(v))
			return new ForallQuantifiedModalFormula(this.getFormula(),this.getQuantifierVariables());
		return new ForallQuantifiedModalFormula(this.getFormula().substitute(v, t),this.getQuantifierVariables());
	}
	...
	@Override
	public ForallQuantifiedModalFormula clone() {
		return new ForallQuantifiedModalFormula(this);
	}
	...
	public Disjunction combineWithOr(Disjunctable f) {
		if(!(f instanceof ModalFormula || f instanceof FolFormula))
			throw new IllegalArgumentException("The given formula " + f + " is not a FolFormula or modal formula.");
	...
	public FolFormula toNnf() {
		if (this.getFormula() instanceof FolFormula) {
			return new ForallQuantifiedModalFormula( ((FolFormula) this.getFormula()).toNnf(), getQuantifierVariables() );
		}
		else {
			throw new UnsupportedOperationException("IMPLEMENT ME");
		}
	...
	public RelationalFormula collapseAssociativeFormulas() {
		if (this.getFormula() instanceof FolFormula) {
			 return new ForallQuantifiedModalFormula( ((FolFormula) this.getFormula()).collapseAssociativeFormulas(), this.getQuantifierVariables() );
		}
		else {
			throw new UnsupportedOperationException("IMPLEMENT ME");
		}
