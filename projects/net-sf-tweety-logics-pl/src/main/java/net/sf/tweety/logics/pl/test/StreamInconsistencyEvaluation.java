...
public class StreamInconsistencyEvaluation {
	...
	public static final int 												SIGNATURE_SIZE				= 30;
	...
	public static final int													STANDARD_EVENTS				= 40000;
	...
	public static void main(String[] args) throws InterruptedException{
		...
		// Window-based MI measure (window size = 50)
		config = new HashMap<String,Object>();
		...
		config.put(WindowInconsistencyMeasurementProcess.CONFIG_WINDOWSIZE, 50);
		config.put(InconsistencyMeasurementProcess.CONFIG_TIMEOUT, TIMEOUT);
		...
		measures.add(mi_1);
		// Window-based MI measure (window size = 100)
		config = new HashMap<String,Object>();
		config.put(WindowInconsistencyMeasurementProcess.CONFIG_MEASURE, new MiInconsistencyMeasure<PropositionalFormula>(STANDARD_MUS_ENUMERATOR));
		config.put(WindowInconsistencyMeasurementProcess.CONFIG_SMOOTHINGFACTOR, STANDARD_SMOOTHING_FACTOR);		
		config.put(WindowInconsistencyMeasurementProcess.CONFIG_WINDOWSIZE, 100);
		config.put(InconsistencyMeasurementProcess.CONFIG_TIMEOUT, TIMEOUT);
		...
		measures.add(mi_2);
		// Window-based MI measure (window size = 200)
		config = new HashMap<String,Object>();
		config.put(WindowInconsistencyMeasurementProcess.CONFIG_MEASURE, new MiInconsistencyMeasure<PropositionalFormula>(STANDARD_MUS_ENUMERATOR));
		config.put(WindowInconsistencyMeasurementProcess.CONFIG_SMOOTHINGFACTOR, STANDARD_SMOOTHING_FACTOR);		
		config.put(WindowInconsistencyMeasurementProcess.CONFIG_WINDOWSIZE, 200);
		config.put(InconsistencyMeasurementProcess.CONFIG_TIMEOUT, TIMEOUT);
		...
		measures.add(mi_3);
		// Window-based MI^C measure (window size = 50)
		config = new HashMap<String,Object>();
		...
		measures.add(mic_1);
		// Window-based MI^C measure (window size = 100)
		config = new HashMap<String,Object>();
		config.put(WindowInconsistencyMeasurementProcess.CONFIG_MEASURE, new MicInconsistencyMeasure<PropositionalFormula>(STANDARD_MUS_ENUMERATOR));
		config.put(WindowInconsistencyMeasurementProcess.CONFIG_SMOOTHINGFACTOR, STANDARD_SMOOTHING_FACTOR);		
		config.put(WindowInconsistencyMeasurementProcess.CONFIG_WINDOWSIZE, 100);
		...
		measures.add(mic_2);
		// Window-based MI^C measure (window size = 200)
		config = new HashMap<String,Object>();
		config.put(WindowInconsistencyMeasurementProcess.CONFIG_MEASURE, new MicInconsistencyMeasure<PropositionalFormula>(STANDARD_MUS_ENUMERATOR));
		config.put(WindowInconsistencyMeasurementProcess.CONFIG_SMOOTHINGFACTOR, STANDARD_SMOOTHING_FACTOR);		
		config.put(WindowInconsistencyMeasurementProcess.CONFIG_WINDOWSIZE, 200);
