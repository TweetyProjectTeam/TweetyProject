...
/**
 * This class implements a reasoner for the admissible semantics in Abstract Dialectical Frameworks (ADFs).
 * It uses a SAT solver to compute admissible interpretations of the ADF.
 * <p>
...
public class AdmissibleReasoner extends AbstractDialecticalFrameworkReasoner {
     ...
     *
     * @param solver the SAT solver to be used for computing admissible interpretations
     */
    ...
    /**
     * Queries the given Abstract Dialectical Framework (ADF) for admissible interpretations.
     * This method retrieves the query that computes the admissible interpretations for the ADF.
     *
     * @param adf the Abstract Dialectical Framework to query for admissible interpretations
     * @return a query that streams the admissible interpretations of the ADF
     */
    @Override
